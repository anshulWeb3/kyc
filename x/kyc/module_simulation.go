...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgUpdateKyc,
		kycsimulation.SimulateMsgUpdateKyc(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeleteKyc,
		kycsimulation.SimulateMsgDeleteKyc(am.accountKeeper, am.bankKeeper, am.keeper),
	))
